    ...
    useEffect(() => {
        ...
        class App {
            ...
            init() {
                ...
                const handleMouseMove = (ev: MouseEvent) => this.onMouseMove(ev);
                container.addEventListener("mousemove", handleMouseMove);

                const handleTouchMove = (ev: TouchEvent) => this.onTouchMove(ev);
                container.addEventListener("touchmove", handleTouchMove);

                // Attach handlers to instance for cleanup
                (this as any).cleanup = () => {
            ...
            onMouseMove(ev: MouseEvent) {
                const rect = container.getBoundingClientRect();
                this.handleInput(ev.clientX - rect.left, ev.clientY - rect.top);
            }
        ...
        return () => {
            if ((app as any).cleanup) {
                (app as any).cleanup();
            }
            if (container && container.contains(app.renderer.domElement)) {
